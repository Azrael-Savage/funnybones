          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Athena`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Software Engineer","Full Stack Web Developer", "Web Designer", "UI/UX Designer" ]'><span className="wrap">{text}</span></span></h1>
                  <p>  As a software engineer with a passion for technology,
                        ...
                        and building innovative solutions. With my self-motivation, ambition, and natural
                        curiosity, I am a software engineer who is committed to
                        excellence. I just finished a web development boot-camp
